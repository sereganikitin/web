...
export default function Hero({
  ...
  // line1 + line2 рендерим как единую фразу — пользователь хотел в одну строку.
  // line2 подсвечен accent-цветом.
  ...
  return (
    ...
    >
      ...
      <div className="container-site relative flex w-full flex-col">
        ...
        <h1 className="font-serif text-5xl leading-[0.95] tracking-tight sm:text-6xl md:text-7xl lg:text-8xl">
        ...
        {/* KPI-строка */}
        <div className="mt-20 grid grid-cols-2 gap-y-6 border-t border-text/5 pt-8 md:grid-cols-4">
          {KPI.map((k) => (
            <div key={k.label}>
